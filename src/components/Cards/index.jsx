...
export default function Cards(props) {
    ...
    const cssClassesWrapper = classNamesStyle({
        ...
        'mp-hover-box-best': (props.type === 'best'),
        'mp-hover-box-rekomendasi-products': (props.type === 'rekomendasi-products'),
    ...
    const titleCard = classNamesStyle({
        ...
        'mp-cards-title-best': (props.type === 'best'),
        'mp-cards-title-rekomendasi-products': (props.type === 'rekomendasi-products'),
        'mp-cards-title-default':(props.type === 'default')
    });

    const priceCard = classNamesStyle({
        'mp-cards-price-popular': (props.type === 'popular'),
        'mp-cards-price-best': (props.type === 'best' || props.type === 'rekomendasi-products'),
...
Cards.propTypes = {
    type: PropTypes.oneOf(['popular', 'best', 'rekomendasi-products']),
